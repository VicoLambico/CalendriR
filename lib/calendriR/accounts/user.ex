defmodule CalendriR.Accounts.User do
  use Ecto.Schema
  ...
  defp validate_username(changeset, _opts) do
    ...
    |> unsafe_validate_unique(:username, CalendriR.Repo)
  ...
  defp maybe_validate_unique_email(changeset, opts) do
    if Keyword.get(opts, :validate_email, true) do
      changeset
      |> unsafe_validate_unique(:email, CalendriR.Repo)
  ...
  """
  def valid_password?(%CalendriR.Accounts.User{hashed_password: hashed_password}, password)
